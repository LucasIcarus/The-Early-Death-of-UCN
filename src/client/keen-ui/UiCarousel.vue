...
<div class="ui-carousel">
    ...
    <div class="ui-carousel-arrow-left" v-if="controlArrow" :style="arrowLeft">
        <ui-icon icon="navigate_before" @click.native="prev"></ui-icon>
    </div>
    <div class="ui-carousel-arrow-right" v-if="controlArrow" :style="arrowRight">
        <ui-icon icon="navigate_next" @click.native="next"></ui-icon>
    </div>
</div>
</template>
